  ...
  SecurityFilterChain filter(HttpSecurity http) throws Exception {
    return http
            ...
            .authorizeHttpRequests(authz -> authz
                    ...
                    .requestMatchers(HttpMethod.POST, "/reminders/save").permitAll()
                    .requestMatchers(HttpMethod.GET, "/reminders/user/{userId}").permitAll()
                    .requestMatchers(HttpMethod.DELETE, "/reminders/{reminderId}").permitAll()
                    .requestMatchers(HttpMethod.POST, "/bookmarks/save").permitAll()
                    .requestMatchers(HttpMethod.DELETE, "/bookmarks/delete/{userId}/{eventId}").permitAll()
                    .requestMatchers(HttpMethod.GET, "/bookmarks/{userId}/{eventId}").permitAll()
                    .requestMatchers(HttpMethod.GET, "/bookmarks/{userId}").permitAll()
                    .requestMatchers(HttpMethod.GET, "/events/date").permitAll()
